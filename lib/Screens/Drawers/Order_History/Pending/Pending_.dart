...
class Pending_ extends StatefulWidget {
  ...
  @override
  State<Pending_> createState() => _Pending_State();
}

class _Pending_State extends State<Pending_> {
  @override
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Padding(
                        ...
                        child: SizedBox(
                            ...
                            child: Image.asset('assets/SendPackage/giphy.gif')))
                  ],
                ),
                SizedBox(
                ...
                Text(
                  "${widget.orderId}${storedUID.substring(0, 5)}",
                            ...
                            TextSpan(
                              ...
                              style: const TextStyle(
                                ...
                                fontWeight: FontWeight
                                    .w400, // Keep the font weight for dynamic text
                                color: Color(
                                    0xFFC02525), // Keep the color for dynamic text
                              ),
                            ),
                          ],
                        ),
